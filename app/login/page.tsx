...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-white text-slate-950">
      {/* GRID INVERTIDO: 1.08fr para o visual (esquerda), 0.92fr para o formulário (direita) */}
      <div className="grid min-h-screen lg:grid-cols-[1.08fr_0.92fr]">
        
        {/* COLUNA ESQUERDA - PAINEL VISUAL (Passou a ser o primeiro elemento) */}
        ...
        {/* COLUNA DIREITA - FORMULÁRIO (Passou a ser o segundo elemento) */}
          ...
          <div className="w-full max-w-115">
            ...
            <div className="mt-9">
              ...
              >
                ...
                {carregandoGoogle ? "Abrindo o Google..." : "Continuar com o Google"}
              </button>
            ...
            <form onSubmit={entrar} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input id="senha" type={mostrarSenha ? "text" : "password"} value={senha} onChange={(e) => setSenha(e.target.value)} placeholder="Digite sua senha" autoComplete="current-password" required className="h-14 w-full rounded-xl border border-slate-300 bg-white pl-12 pr-12 text-base text-slate-950 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-100" />
              ...
              <button type="submit" disabled={algumaAcaoCarregando} className="inline-flex h-14 w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-6 text-base font-extrabold text-white shadow-[0_14px_32px_rgba(37,99,235,0.28)] transition hover:-translate-y-0.5 hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-60">
                {carregando ? (
                  ...
                  <><ArrowRight className="size-5" /> Entrar na plataforma</>
                )}
              </button>
            </form>
            ...
            <p className="mt-7 text-center text-sm text-slate-600">
              ...
              <Link href="/cadastro" className="font-extrabold text-blue-700 transition hover:text-blue-900">
                Criar conta gratuitamente
              </Link>
            </p>

            <p className="mt-8 text-center text-xs leading-5 text-slate-400">
              Ao entrar, você concorda com os Termos de Uso e a Política de Privacidade da plataforma.
            </p>
          </div>
        </section>
      </div>
